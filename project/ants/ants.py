...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while True:
            ...
            chosen_bee = bee_selector(bee_list)
            if current_place.bees is beehive.bees:
                break
            
            elif chosen_bee is not None and self.min_range <= count <= self.max_range:
                return chosen_bee
...
# END Problem EC
        ...
        if not self.check:
            ...
            while True:
                ...
                if current_place.ant != None:
                    ...
                    if current_place.ant.is_container() and current_place.ant.contained_ant != None:
                        current_place.ant.contained_ant.buff()
    ...
    def reduce_health(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        super().reduce_health(amount)
        if self.health <= 0 and self.check:
            bees_win()
        # END Problem EC
